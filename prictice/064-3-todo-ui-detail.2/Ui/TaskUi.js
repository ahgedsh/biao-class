...
// function detect_input_focus(){//当input focus 时显示select框
//     var me=this;
...
// function detect_click_list(){//点击list 时看是删除还是更新
//     var me=this;
...
//         me.input.value='';
//         if(me.config.on_add_succeed)//一个接口，添加一项时隐藏select
//         me.config.on_add_succeed();

//     })
// }

// function remove(id){//删除是执行的
//     this._api.remove(id);
//     this.render();
// }
...
//     var todo_list=cat_id ?//是否有——cat_idid 有就渲染指定的cat_id的数据
//                   this._api.read_by_cat(cat_id) :
//                   this._api.read();//没有就渲染所有
//     var me=this;
