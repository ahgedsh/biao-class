...
//         let key=arr[0];
//         let val=arr[1];
//         //如果只有键没有值，required没有值，那么val就等于true
...
//         let rule=binding.value;//required | min_length:4 | username;
//         let selector=el.getAttribute('error-el');//用于线显示错误得信息的选择器
//         let error_el=document.querySelector(selector);//用于显示错误信息的元素
//         lang=el.getAttribute('error-lang')||'zh';//错误信息的语言
...
//                 let val=el.value;//用户在input里面定义的值
//                 inner_msg='';//清空
